...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Sus características principales son: 
    ...
    SlyderF.color-acento-botones.mb-5(columnas="col-lg-6 col-xl-4")
      .tarjeta.tarjeta--BG02.color-primario.p-4
        ...
        p.text-center.mb-0 La afiliación se realiza mediante una EPS (Entidad Promotora de Salud), que actúa como intermediaria entre el usuario y los prestadores de servicios.
      .tarjeta.tarjeta--BG02.color-primario.p-4
        .row.justify-content-center.mb-3
          .col-lg-6.col-sm-4.col-6
            img(src='@/assets/curso/temas/tema2/img3.svg' alt='Imagen decorativa')
        h5.text-center Aportes
        p.text-center.mb-0 Los cotizantes aportan un porcentaje fijo sobre sus ingresos mensuales (actualmente alrededor del 12.5 %), que incluye contribuciones tanto del empleador como del trabajador.
      .tarjeta.tarjeta--BG02.color-primario.p-4
        .row.justify-content-center.mb-3
          .col-lg-6.col-sm-4.col-6
    ...
    .tarjeta--BG020.px-md-5.px-4
      ...
      .row.justify-content-center.align-items-center
        .col-lg-3.col-6.mb-md-4(data-aos="fade-left")
          figure
    ...
    .tarjeta-BG02.px-md-5.px-4
      ...
      .row.justify-content-center.align-items-center.mb-4
        .col-lg-2.col-4.mb-lg-0.mb-4(data-aos="fade-left")
          figure
    ...
    .tarjeta-BG02.px-md-5.px-4
      ...
      .row.justify-content-center.align-items-center.mb-5
        ...
        .col-lg-3.col-6.mb-lg-0.mb-4.order-1.order-lg-2(data-aos="fade-right")
          figure
    ...
    .tarjeta--container.row.mb-5
      .col-md.tarjeta.color-primario.tarjcone.p-5(data-aos="fade-left")
        ...
        .row.justify-content-center.align-items-center
          .col-10
            ...
            p.mb-0 El Estado asume el costo por medio de transferencias directas a las EPS que prestan servicios a esta población vulnerable.
      .col-md.tarjeta.color-secundario.tarjcone.p-5(data-aos="fade-right")
        .row.justify-content-center.mb-5
          .col-lg-3.col-6
            figure
        ...
        .row.justify-content-center.align-items-center
          .col-10
            ...
            p.mb-0 El Estado colombiano asigna recursos fiscales al sistema de salud mediante presupuestos nacionales y departamentales.
      ...
      .col-lg-6.mb-lg-0.mb-4(data-aos="fade-left")
        .tarjeta.tarjeta--BG03.h-100
          ...
          .p-4
            ...
            p.mb-0 Incluyen fondos destinados a programas específicos, subsidios y financiamiento estructural.
      .col-lg-6(data-aos="fade-right")
        .tarjeta.tarjeta--BG03.h-100
          ...
          .p-4
            ...
            p.mb-0 Los municipios y departamentos también destinan recursos propios para financiar servicios básicos relacionados con salud pública, atención primaria y programas preventivos.
    
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10(data-aos="fade-left")
        p.mb-0 Estos recursos son fundamentales para garantizar la cobertura universal, especialmente para poblaciones vulnerables o en zonas rurales alejadas; aunque, como una limitante, se tiene que la asignación presupuestal puede ser insuficiente.
        ...
        LineaTiempoD.color-acento-botones
          .row.justify-content-center(numero="1" titulo="Cumple condiciones")
            .col-lg-12.order-lg-2.order-3
              p.mb-0 Cuando la persona reúna condiciones para pertenecer al régimen contributivo, la registrará en el Sistema Afiliación Transaccional y la inscribirá en una EPS de dicho régimen.
          ...
          .row.justify-content-center(numero="2" titulo="Sisbén I y II")          
            .col-lg-12.order-lg-2.order-3
              p.mb-0 Cuando la persona declare que no cumple las condiciones para pertenecer al régimen contributivo y se encuentre clasificado en los niveles I y II del Sisbén, la registrará en el Sistema de Afiliación Transaccional y lo inscribirá en una EPS del Régimen Subsidiado en el respectivo municipio.
            .col-lg-12.order-lg-3.order-1.mb-md-4
              figure
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10(data-aos="fade-left")
        p.mb-0 Sin embargo, la persona podrá ejercer el derecho a la libre escogencia de EPS dentro de los noventa (90) días calendario contados a partir de la inscripción. (…)
        ...
        .col
          .row.justify-content-between.align-items-center
            .col.mb-sm-0.mb-5
              ...
              p.mb-0 Para estos efectos de la afiliación, se puede realizar través de la página https://www.miseguridadsocial.gov.co, Sistema de Afiliación Transaccional (SAT), para lo cual la IPS o la entidad territorial deben estar registradas para realizar los respectivos trámites mediante esta herramienta.  
            .col-sm-auto
