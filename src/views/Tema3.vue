...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Este sistema suele estar compuesto por varias funciones clave:
    ...
    SlyderF.color-acento-botones.mb-5(columnas="col-lg-6 col-xl-4")
      ...
      .tarjeta.tarjeta--BG02.color-primario.p-4
        ...
        p.text-center.mb-0 El sistema puede generar informes detallados sobre las afiliaciones, transacciones realizadas, tasas de retención, entre otros datos importantes para la toma de decisiones.
    
    p.mb-5 Este sistema es muy utilizado en diferentes ámbitos, como en programas de fidelización, plataformas de comercio electrónico, servicios de suscripción y en algunos casos, en sistemas gubernamentales o empresariales que requieren un control riguroso de afiliaciones y transacciones relacionadas.
    ...
    p.mb-5 Es un proceso que permite a un grupo de personas, como empleados de una empresa, instituciones o comunidades, inscribirse de manera conjunta en el sistema de seguridad social en salud. A continuación, se explica de manera amigable y detallada, cómo suele ser el procedimiento general:
    
    .tarjeta--BG043.p-4.px-md-5.mb-4
        ...
        PasosB.color-acento-botones
          .row
            .col-lg-5.order-2.order-lg-1
              ...
              p.mb-0 Generalmente, la afiliación colectiva la realiza la empresa, organización o entidad que actúa como responsable del grupo. Esta puede ser una empresa, una institución educativa, una organización sin ánimo de lucro, entre otras.
          ...
          .row
            .col-lg-5.order-2.order-lg-1
              ...
              p.mb-0 Se verifica que los afiliados cumplan con los requisitos para afiliarse, como no estar ya afiliados a otro sistema de salud o cumplir con las condiciones específicas según la categoría de afiliación (empleado, beneficiario, etc.).
            .col-lg-6.mb-lg-0.mb-4.order-1.order-lg-2
              figure
          ...
          .row
            .col-lg-5.order-2.order-lg-1
              ...
              p.mb-0 La entidad responsable realiza el proceso de afiliación, a través de los canales establecidos por el sistema de salud en Colombia, que puede ser en línea, en las oficinas de las EPS o mediante plataformas autorizadas. En algunos casos, se puede hacer por medio de un formulario físico o digital.
            .col-lg-6.mb-lg-0.mb-4.order-1.order-lg-2
              figure
          ...
          .row
            .col-lg-5.order-2.order-lg-1
              h4 Pago de aportes
              p.mb-0 La afiliación colectiva implica que la entidad responsable asuma ciertos aportes económicos, que corresponden a la cotización del grupo. Estos pagos se realizan periódicamente y deben cumplir con los porcentajes establecidos por la ley.
            .col-lg-6.mb-lg-0.mb-4.order-1.order-lg-2
              figure
          ...
          .row
            .col-lg-5.order-2.order-lg-1
              ...
              p.mb-0 Una vez completados los pasos anteriores, se confirma la afiliación y se entregan los carnés o comprobantes de afiliación a cada beneficiario, quienes podrán acceder a los servicios de salud.
            .col-lg-6.mb-lg-0.mb-4.order-1.order-lg-2
              figure
          ...
          .row
            .col-md-5.order-2.order-lg-1
              ...
              p.mb-0 Es importante mantener actualizada la información y realizar los cambios necesarios en caso de novedades, como cambios en la nómina, incorporación de nuevos miembros o bajas.
            .col-lg-6.mb-lg-0.mb-4.order-1.order-lg-2
              figure
    ...
    p.mb-5 Mediante los siguientes procesos:
    ...
    p.mb-5 Al respecto, es importante tener en cuenta los siguientes valores:
